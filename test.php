...
require_once OAUTH_LIBRARY.'oauth-client.php';
require_once OAUTH_LIBRARY.'oauth-communicator.php';
require_once FBOAUTH_LIBRARY.'fb-oauth-app.php';
require_once FB_LIBRARY.'fb-login-dialog.php';
require_once FBOAUTH_LIBRARY.'fb-oauth-accesstoken.php';
require_once FB_LIBRARY.'fb-response.php';
require_once FB_ENDPOINTS.'fb-endpoint.php';
require_once FB_ENDPOINTS.'fb-endpoint-user.php';
require_once FB_ENDPOINTS.'fb-endpoint-feed.php';
require_once FB_ENDPOINTS.'fb-endpoint-photos.php';
require_once FB_ENDPOINTS.'fb-endpoint-comments.php';
require_once FB_ENDPOINTS.'fb-endpoint-likes.php';
...
$Endpoint = new StileroFBEndpointPhotos($AccessToken, $lfkgroupid);
$response = $Endpoint->publishFromUrl('http://ilovephoto.se/cache/widgetkit/gallery/35/portfolio-photography-corporate-12-13120909-80e454ffce.jpg', 'En bild från ett projekt jag jobbar med just nu.');
